...
export default function DetalleHorarioPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        setItems([
            ...
            { label: `${horario?.hora_inicio}`, isCurrentPage: true },
        ])
    }, [setItems, horario])
            ...
            <Card className="max-w-2xl mx-auto">
                ...
                <CardContent className="space-y-6">
                    {/* <div>
                        ...
                        <div className="p-2 bg-muted rounded-md">{horario.numMatricula}</div>
                    </div> */}

                    <div>
                        <h3 className="font-medium text-sm text-muted-foreground mb-1">Horario inicial</h3>
                        <div className="p-2 bg-muted rounded-md">{horario.hora_inicio}</div>
                    </div>

                    <div>
                        <h3 className="font-medium text-sm text-muted-foreground mb-1">Horario Final</h3>
                        <div className="p-2 bg-muted rounded-md">{horario.hora_final}</div>
                    </div>
                </CardContent>
            </Card>
